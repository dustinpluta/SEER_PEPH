...
def test_run_joint_analysis_cli_smoke_nondefault_schema(tmp_path: Path) -> None:
    ...
    out_dir = tmp_path / "joint_analysis_cli_artifacts"
    config_path = tmp_path / "joint_analysis_config.json"
    ...
    script_path = repo_root / "scripts" / "run_joint_analysis.py"
    ...
    assert "Joint analysis completed." in result.stdout
